...
score4 = [] 
with open(RESULT_PATH / "{x}_4.txt".format(x=score), "r") as f:
  for line in f:
      x = (line.strip())
      score4.append(float(x))
    
score8 = [] 
with open(RESULT_PATH /"{x}_8.txt".format(x=score), "r") as f:
  for line in f:
      x = line.strip()
      score8.append(float(x))

score12 = [] 
with open(RESULT_PATH /"{x}_12.txt".format(x=score), "r") as f:
  for line in f:
      x = line.strip()
...
score20 = [] 
with open(RESULT_PATH /"{x}_20.txt".format(x=score), "r") as f:
  for line in f:
      x = line.strip()
...
score28 = [] 
with open(RESULT_PATH /"{x}_28.txt".format(x=score), "r") as f:
  for line in f:
      x = line.strip()
      score28.append(float(x))
      
score32 = [] 
with open(RESULT_PATH /"{x}_32.txt".format(x=score), "r") as f:
  for line in f:
      x = line.strip()
